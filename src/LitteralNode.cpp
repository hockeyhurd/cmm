...
namespace cmm
{
    ...
    LitteralNode::LitteralNode(const Location& location, const char* value) CMM_NOEXCEPT :
        ExpressionNode(NodeType::LITTERAL, location, CType(EnumCType::STRING)),
