...
namespace cmm
{
    ...
    enum class NodeType
    {
        UNKNOWN = 0, COMPILATION_UNIT, BIN_OP, FUNCTION_DECLARATION_STATEMENT, EXPRESSION_STATEMENT,
        EXPRESSION, PAREN_EXPRESSION, LITTERAL, VARIABLE, VARIABLE_DECLARATION_STATEMENT
    };
